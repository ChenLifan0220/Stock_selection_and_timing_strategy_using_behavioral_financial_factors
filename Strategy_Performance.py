...
Monthly_sequence=[int(x) for x in monthly_sequence]
...
def Performance(return_list, index_num):
    ...
    simple_anualized_return_benchmark=Simple_Annualized_return(index_value)
    print("-----------------------------------------------------")
    ...
    print("Annualized rate of benchmark is " + str(round(simple_anualized_return_benchmark,4)))
